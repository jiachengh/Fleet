...
inline uint32_t Object::GetLockOwnerThreadId() {
  // marvin start
  // jiacheng start
  // SWAP_PREAMBLE(GetLockOwnerThreadId, Object, uint32_t, )
  // jiacheng end
  // marvin end
...
inline ObjPtr<mirror::Object> Object::MonitorEnter(Thread* self) {
  // marvin start
  // SWAP_PREAMBLE(MonitorEnter, Object, ObjPtr<mirror::Object>, self)
  // marvin end
...
inline ObjPtr<mirror::Object> Object::MonitorTryEnter(Thread* self) {
  // marvin start
  // SWAP_PREAMBLE(MonitorTryEnter, Object, ObjPtr<mirror::Object>, self)
  // marvin end
...
inline bool Object::MonitorExit(Thread* self) {
  // marvin start
  // SWAP_PREAMBLE(MonitorExit, Object, bool, self)
  // marvin end
...
inline void Object::Notify(Thread* self) {
  // marvin start
  // SWAP_PREAMBLE_VOID(Notify, Object, self)
  // marvin end
...
inline void Object::NotifyAll(Thread* self) {
  // marvin start
  // SWAP_PREAMBLE_VOID(NotifyAll, Object, self)
  // marvin end
...
inline void Object::Wait(Thread* self, int64_t ms, int32_t ns) {
  // marvin start
  // SWAP_PREAMBLE_VOID(Wait, Object, self, ms, ns)
  // marvin end
...
inline ObjPtr<Class> Object::AsClass() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsClass, Object, ObjPtr<Class>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<ObjectArray<T>> Object::AsObjectArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsObjectArray, Object, ObjPtr<ObjectArray<T>>, GATHER_TEMPLATE_ARGS(T, kVerifyFlags), )
  // marvin end
...
inline ObjPtr<Reference> Object::AsReference() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsReference, Object, ObjPtr<Reference>, GATHER_TEMPLATE_ARGS(kVerifyFlags, kReadBarrierOption), )
  // marvin end
...
inline ObjPtr<Array> Object::AsArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsArray, Object, ObjPtr<Array>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<BooleanArray> Object::AsBooleanArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsBooleanArray, Object, ObjPtr<BooleanArray>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<ByteArray> Object::AsByteArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsByteArray, Object, ObjPtr<ByteArray>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<CharArray> Object::AsCharArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsCharArray, Object, ObjPtr<CharArray>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<ShortArray> Object::AsShortArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsShortArray, Object, ObjPtr<ShortArray>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<IntArray> Object::AsIntArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsIntArray, Object, ObjPtr<IntArray>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<LongArray> Object::AsLongArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsLongArray, Object, ObjPtr<LongArray>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<FloatArray> Object::AsFloatArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsFloatArray, Object, ObjPtr<FloatArray>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<DoubleArray> Object::AsDoubleArray() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsDoubleArray, Object, ObjPtr<DoubleArray>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<String> Object::AsString() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsString, Object, ObjPtr<String>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<Throwable> Object::AsThrowable() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsThrowable, Object, ObjPtr<Throwable>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline ObjPtr<FinalizerReference> Object::AsFinalizerReference() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsFinalizerReference, Object, ObjPtr<FinalizerReference>, GATHER_TEMPLATE_ARGS(kVerifyFlags), )
  // marvin end
...
inline size_t Object::SizeOf() {
  ...
  //   result = stub->GetSize();
  // } else if (IsArrayInstance<kVerifyFlags>()) {
  // jiacheng end
...
inline ObjPtr<mirror::DexCache> Object::AsDexCache() {
  // marvin start
  // SWAP_PREAMBLE_TEMPLATE(AsDexCache, Object, ObjPtr<mirror::DexCache>, GATHER_TEMPLATE_ARGS(kVerifyFlags, kReadBarrierOption), )
  // marvin end
